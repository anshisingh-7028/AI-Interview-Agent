...
function Step3Report({ report }) {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-red-50 px-4 sm:px-6 lg:px-10 py-8'>
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        ...
        <button onClick={downloadPDF} className='bg-red-600 hover:bg-red-800 text-white px-6 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap'>Download PDF</button>
      </div>
                ...
                skills.map((s, i) => (
                  <div key={i}>
                    ...
                    <div className='bg-gray-200 h-2 sm:h-3 rounded-full'>
                      <div className='bg-red-800 h-full rounded-full'
              ...
              {questionWiseScore.map((q, i) => (
                <div key={i} className='bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200'>
                  ...
                  <div className='flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4'>
                    ...
                    <div className='bg-green-100 text-red-800 px-3 py-1 rounded-full font-bold text-xs sm:text-sm w-fit'>
                      {q.score ?? 0}/10
                    </div>
                  </div>

                  <div className='bg-green-50 border border-red-200 p-4 rounded-lg'>
