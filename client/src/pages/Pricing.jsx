...
function Pricing() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-red-50 py-16 px-6'>
          ...
          return (
            <motion.div key={plan.id}
              ...
              className={`relative rounded-3xl p-8 transition-all duration-300 border 
                ${isSelected
                  ? "border-red-600 shadow-2xl bg-white"
              ...
              {!plan.default &&
                ...
                disabled={loadingPlan === plan.id}
                  onClick={(e) => {
                    ...
                    : "bg-red-100 text-gray-700 hover:bg-red-50"
                    }`}>
                  {loadingPlan === plan.id
                    ? "Processing..."
                    : isSelected
